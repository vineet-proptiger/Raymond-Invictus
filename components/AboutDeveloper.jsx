        ...
        <div style={{
          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <p style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 20px' }}>
              Raymond Realty is the real estate arm of the iconic Raymond Group — a name synonymous with quality, trust and refined living. With a legacy of excellence spanning decades, Raymond Realty brings the same precision and craftsmanship to their residences, delivering world-class homes that reflect a life well-lived.</p>
