...
import { heroImages } from '../../../lib/wadala-east-mumbai/images'
    ...
    <section className="hero-container">
      <style dangerouslySetInnerHTML={{ __html: `
        .hero-container {
          ...
          height: auto;
          overflow: hidden;
          background-image: url('/wadala-east-mumbai/images/hero/banner1.webp');
        ...
        @media (max-width: 767px) {
          ...
          .hero-image {
            ...
            .hero-content::before {
              ...
              -webkit-mask-image: url('/wadala-east-mumbai/images/hero/leaf-bg.png');
              mask-image: url('/wadala-east-mumbai/images/hero/leaf-bg.png');
      ...
      <div className="block md:hidden relative w-full bg-[#0F172A]">
        <Image
          src={heroImages.smDevice || '/wadala-east-mumbai/images/hero/smDevice.webp'}
