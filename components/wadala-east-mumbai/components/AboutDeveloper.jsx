...
const AboutDeveloper = ({ setIsOpen }) => (
  <section id="developer" className="py-16 sm:py-20 relative bg-fixed bg-cover bg-center border-b border-gray-100" style={{ backgroundImage: 'url(/wadala-east-mumbai/images/about-devloper/about-dev.webp)' }}>
