...
const Footer = () => (
  <footer className="relative bg-cover bg-center bg-fixed" style={{ backgroundImage: "url('/wadala-east-mumbai/images/footer/footer.webp')", color: '#fff' }}>
    ...
    <div className="relative z-10">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-4 py-4 px-6 border-t border-[#222] text-center sm:text-left max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-6">
          ...
          <Link href="/the-address-by-gs-wadala/privacy-policy" style={{ fontSize: '13px', color: 'var(--color-gold)', fontFamily: F_SANS }}>
            Privacy Policy
          </Link>
        </div>
      </div>
