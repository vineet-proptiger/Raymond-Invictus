...
import { Dumbbell, Flower2, Users, Baby, Waves, Flame, Building2, PawPrint } from 'lucide-react'
...
const highlights = [
  ...
  {
    text: 'Yoga & Meditation Zone',
    icon: <Flower2 {...highlightIconProps} />,
  },
  {
    text: 'Senior Citizen Zone',
    icon: <Users {...highlightIconProps} />,
  },
  {
    text: "Kids' Pool",
    icon: <Baby {...highlightIconProps} />,
  },
  {
    text: 'Lap Pool',
  ...
  {
    text: 'Alfresco Grill Deck',
    icon: <Flame {...highlightIconProps} />,
  },
  {
  ...
  {
    text: 'Pet Park',
    icon: <PawPrint {...highlightIconProps} />,
  },
]
