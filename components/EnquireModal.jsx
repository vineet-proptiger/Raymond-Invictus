      ...
      <div className="relative bg-white w-full rounded-2xl overflow-hidden shadow-2xl flex flex-col sm:flex-row"
        ...
        <div className="flex-1 flex flex-col overflow-y-auto">
          ...
          <div className="sm:hidden w-full h-44 relative shrink-0">
            <Image src={popupImage} alt="Invictus by GS" fill className="object-cover object-top" sizes="100vw" />
            ...
            <div className="absolute bottom-3 left-4 text-white z-10">
              <p className="text-[9px] uppercase tracking-[2px] opacity-80" style={{ fontFamily: F_SANS }}>Raymond Invictus by GS</p>
              <p className="text-[11px] font-medium opacity-85" style={{ fontFamily: F_JOST }}>BKC, Bandra Kurla Complex, Mumbai</p>
            </div>
          </div>
