    ...
    <section id="overview" className="!pt-1 !pb-4 sm:!py-10" style={{
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div style={{ textAlign: 'center', marginBottom: '36px' }} data-aos="fade-up">
          ...
          }}>Raymond Reality New Launch</span>
          <h2 style={{
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
          ...
          <div data-aos="fade-right" style={{ display: 'flex' }}>
            <div style={{
              ...
              <Image src={overviewImage} alt="Invictus by GS" fill className="object-cover object-top"
          ...
          <div data-aos="fade-up" style={{ display: 'flex' }}>
            <div style={{
              ...
              <div style={{ position: 'relative' }}>
                <h3 style={{
                  fontFamily: F_JOST, fontWeight: '800', fontSize: '14px',
                  color: '#111827', margin: '0 0 14px', letterSpacing: '0.06em',
