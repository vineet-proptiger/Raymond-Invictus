...
import { galleryImages, amenityImages } from '../../lib/wadala-east-mumbai/images'

import Navbar from '../../components/wadala-east-mumbai/components/Navbar'
import Hero from '../../components/wadala-east-mumbai/components/Hero'

const Overview = dynamic(() => import('../../components/wadala-east-mumbai/components/Overview'), { ssr: true })
// const Projects = dynamic(() => import('../../components/wadala-east-mumbai/components/Projects'), { ssr: true })
const Highlights = dynamic(() => import('../../components/wadala-east-mumbai/components/Highlights'), { ssr: true })
const Amenities = dynamic(() => import('../../components/wadala-east-mumbai/components/Amenities'), { ssr: true })
const Pricing = dynamic(() => import('../../components/wadala-east-mumbai/components/Pricing'), { ssr: true })
const Location = dynamic(() => import('../../components/wadala-east-mumbai/components/Location'), { ssr: true })
const MasterPlan = dynamic(() => import('../../components/wadala-east-mumbai/components/MasterPlan'), { ssr: true })
// const PaymentPlan = dynamic(() => import('../../components/wadala-east-mumbai/components/PaymentPlan'), { ssr: true })
const AboutDeveloper = dynamic(() => import('../../components/wadala-east-mumbai/components/AboutDeveloper'), { ssr: true })
const QuickChat = dynamic(() => import('../../components/wadala-east-mumbai/components/QuickChat'), { ssr: true })
const Footer = dynamic(() => import('../../components/wadala-east-mumbai/components/Footer'), { ssr: true })

const Gallery = dynamic(() => import('../../components/wadala-east-mumbai/components/Gallery'), { ssr: false })
// const VirtualTour = dynamic(() => import('../../components/wadala-east-mumbai/components/VirtualTour'), { ssr: false })
const CarouselSection = dynamic(() => import('../../components/wadala-east-mumbai/components/CarouselSection'), { ssr: false })
// const ExclusiveAmenities = dynamic(() => import('../../components/wadala-east-mumbai/components/ExclusiveAmenities'), { ssr: false })
// const Sustainability = dynamic(() => import('../../components/wadala-east-mumbai/components/Sustainability'), { ssr: false })
// const JapaneseExcellence = dynamic(() => import('../../components/wadala-east-mumbai/components/JapaneseExcellence'), { ssr: false })
const EnquireModal = dynamic(() => import('../../components/wadala-east-mumbai/components/EnquireModal'), { ssr: false })
const AosInit = dynamic(() => import('../../components/wadala-east-mumbai/components/AosInit'), { ssr: false })
    ...
    <main className="relative min-h-screen bg-white">
      ...
      <div className="sticky-bottom-bar bg-[#0f172a] items-center justify-between px-3 py-[10px] gap-3 shadow-[0_-4px_20px_rgba(0,0,0,0.15)]">
        ...
        <div className="flex items-center gap-[6px]">
          ...
          <a
            href="https://wa.me/919718344024?text=Hi%2C%20I%20am%20interested%20in%20Raymond%20The%20Address%20By%20GS%20Wadala"
