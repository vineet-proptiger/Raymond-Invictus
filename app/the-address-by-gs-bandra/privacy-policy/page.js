...
import { logoImages } from '../../../lib/bandra-east-mumbai/images'
import AosInit from '../../../components/bandra-east-mumbai/AosInit'
    ...
    <main className="min-h-screen bg-white">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 bg-white transition-shadow duration-300 ${scrolled ? 'shadow-md' : 'shadow-sm'}`}>
        ...
        <div className="container mx-auto px-4 md:px-8 flex items-center justify-between h-[80px]">
          <Link href="/the-address-by-gs-bandra" className="flex items-center">
            <style>{`
              ...
              @media(max-width: 768px) {
                .privacy-logo { height: 60px; min-height: 60px; transform-origin: left center; transform: scale(1.15); margin-left: 0; }
              }
            `}</style>
            <img src={logoImages.main} alt="Raymond The Address By GS" className="privacy-logo" />
          </Link>
          <Link
            href="/the-address-by-gs-bandra"
      ...
      >
        ...
        <div className="relative z-10 px-4 py-10 sm:py-16" data-aos="fade-up">
          ...
          <div className="flex items-center justify-center gap-2 text-white/80 text-sm" style={{ fontFamily: 'var(--font-sans)' }}>
            <Link href="/the-address-by-gs-bandra" className="hover:text-white transition-colors" style={{ color: 'var(--color-gold)' }}>Home</Link>
            <span>›</span>
      ...
      <footer style={{ background: 'var(--color-dark)', color: '#fff', padding: '24px', textAlign: 'center', borderTop: '1px solid #333' }}>
        <p style={{ fontSize: '13px', color: '#888', fontFamily: 'var(--font-sans)' }}>
          ...
          <Link href="/the-address-by-gs-bandra" style={{ color: 'var(--color-gold)', textDecoration: 'none' }}>Back to Home</Link>
        </p>
      </footer>
    </main>
  )
