...
import { galleryImages, amenityImages } from '../../lib/bandra-east-mumbai/images'

import Navbar from '../../components/bandra-east-mumbai/Navbar'
import Hero from '../../components/bandra-east-mumbai/Hero'

const Overview = dynamic(() => import('../../components/bandra-east-mumbai/Overview'), { ssr: true })
// const Projects = dynamic(() => import('../../components/bandra-east-mumbai/Projects'), { ssr: true })
const Highlights = dynamic(() => import('../../components/bandra-east-mumbai/Highlights'), { ssr: true })
const Amenities = dynamic(() => import('../../components/bandra-east-mumbai/Amenities'), { ssr: true })
const Pricing = dynamic(() => import('../../components/bandra-east-mumbai/Pricing'), { ssr: true })
const Location = dynamic(() => import('../../components/bandra-east-mumbai/Location'), { ssr: true })
const MasterPlan = dynamic(() => import('../../components/bandra-east-mumbai/MasterPlan'), { ssr: true })
// const PaymentPlan = dynamic(() => import('../../components/bandra-east-mumbai/PaymentPlan'), { ssr: true })
const AboutDeveloper = dynamic(() => import('../../components/bandra-east-mumbai/AboutDeveloper'), { ssr: true })
const QuickChat = dynamic(() => import('../../components/bandra-east-mumbai/QuickChat'), { ssr: true })
const Footer = dynamic(() => import('../../components/bandra-east-mumbai/Footer'), { ssr: true })

const Gallery = dynamic(() => import('../../components/bandra-east-mumbai/Gallery'), { ssr: false })
// const VirtualTour = dynamic(() => import('../../components/bandra-east-mumbai/VirtualTour'), { ssr: false })
const CarouselSection = dynamic(() => import('../../components/bandra-east-mumbai/CarouselSection'), { ssr: false })
// const ExclusiveAmenities = dynamic(() => import('../../components/bandra-east-mumbai/ExclusiveAmenities'), { ssr: false })
// const Sustainability = dynamic(() => import('../../components/bandra-east-mumbai/Sustainability'), { ssr: false })
// const JapaneseExcellence = dynamic(() => import('../../components/bandra-east-mumbai/JapaneseExcellence'), { ssr: false })
const EnquireModal = dynamic(() => import('../../components/bandra-east-mumbai/EnquireModal'), { ssr: false })
const AosInit = dynamic(() => import('../../components/bandra-east-mumbai/AosInit'), { ssr: false })
    ...
    <main className="relative min-h-screen bg-white">
      ...
      <div className="sticky-bottom-bar bg-[#0f172a] items-center justify-between px-3 py-[10px] gap-3 shadow-[0_-4px_20px_rgba(0,0,0,0.15)]">
        ...
        <div className="flex items-center gap-[6px]">
          ...
          <a
            href="https://wa.me/919718344024?text=Hi%2C%20I%20am%20interested%20in%20Raymond%20The%20Address%20By%20GS%20Bandra"
